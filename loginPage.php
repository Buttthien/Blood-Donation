...
<script>
    document.getElementById('citizenshipForm').addEventListener('submit', function(event) {
        ...
        // Redirect to DONATORpage.php with the citizenship ID as a query parameter
        window.location.href = 'DONATORpage.php?citizenshipID=' + citizenshipID;
    });
</script>
    ...
    <div class="container-xxl py-5" style="margin-top: 100px; margin-bottom: 100px;">
        <div class="container">
            <div class="row g-5">
                <form class="SignIn" style="max-width: 400px; margin: 0 auto;" action="login.php" method="post">
                    <?php
                        if(isset($_GET['error']))
                        {
                    ?>
                    ...
                    <div class="row g-3">
                        <div class="d-grid">
                            <input type="text" class="form-control border-0" placeholder="Your Username" style="height: 45px;" name="userName">
                        </div>
                        <div class="d-grid">
                            <input type="password" class="form-control border-0" placeholder="Your Password" style="height: 45px;" name="password">
                        </div>
                        <div class="col-12">
    ...
    window.addEventListener('pageshow', function(event) {
        // Check if the page is being loaded from the cache (via the back button)
