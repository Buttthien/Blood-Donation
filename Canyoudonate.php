...
<div>
    ...
    <!-- Can -->
        <div class="container">
          <div class="hero-content">
            ...
            <p class="hero-text">
              <img src="img/donate.png" width="587" height="839" alt="hero banner" class="w-100">             
            </p>
          </div>
    ...
    <!--Can 2 -->
        <div class="container">
          <div class="hero-content">
            <h1 class="h1 can-title">Who can't donate blood</h1>
            <p class="can-text">
          ...
          <figure class="hero-banner">
            <img src="img/donate2.webp" width="587" height="839" alt="hero banner" class="w-100">
          </figure>
        </div>
      ...
      <!--Can 3-->
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="hero-text">
              <img src="img/donate3.png" width="587" height="839" alt="hero banner" class="w-100">             
            </p>
          </div>
          <figure class="hero-banner">
      ...
      <!--Can 4-->
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="img/donate4.jpg" width="587" height="839" alt="hero banner" class="w-100">
          </figure>
        </div>
    ...
    <!--Can 5-->
        <div class="container">
          ...
          <p class="hero-text">
              <img src="img/donate5.png" width="587" height="839" alt="hero banner" class="w-100">             
            </p>
        </div>
        </div>
    <!-- Footer Start -->
